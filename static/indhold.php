...
<div class="container main">
	...
	<div class="static clearfix">
      <h1>Indhold i BIBLIOTEKET</h1>
      <p>I BIBLIOTEKET kan du blandt andet søge og bestille DR&rsquo;s bøger, tidsskrifter, aviser og finde adgang til online databaser. <BR>
        <BR>
      </p>
      <p><strong>Bøger<BR>
      </strong>I BIBLIOTEKET kan du finde bøger, som dækker alle fagområder.  Bøgerne er udvalgt, så de bidrager til inspiration, oplysning og information til DR&rsquo;s medarbejdere og DR&rsquo;s produktion. Bogsamlingen er universel, men dækningen inden for hver emnegruppe varierer i forhold til behovet i DR. </p>
      <p>I BIBLIOTEKET kan du både finde bøger til hjemlån og håndbøger til brug på stedet.</p>
      <p><BR>
      </p>
      ...
      <p><strong><BR>
        Eksterne databaser<BR>
      </strong>Europa World, Faktalink, Greens Online og Gyldendals Røde Ordbøger er blot nogle af de netressourcer, som DR abonnerer på og som du kan søge frem i BIBLIOTEKET. På DRInde kan du læse yderligere om din adgang til <A HREF="http://cmsil/Produktion/Faciliteter+og+ydelser/Arkiv+og+research/Tekst/20090109102824.htm">eksterne databaser</A>.</p>
<p>&nbsp;</p>
